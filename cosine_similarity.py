...
# Scale features (cosine is scale-invariant w.r.t. vector length, but scaling helps when ranges differ)
...
print("
Saved: cosine_similarity_matrix.csv, cosine_similarity_heatmap.png")
